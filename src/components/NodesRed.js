...
redRoute.addNode("AG", { AF: 1, AH: 1, HK: 1 })
...
redRoute.addNode("AN", { AM: 1, HK: 1, HL: 1 })
redRoute.addNode("AO", { AJ: 1, AP: 1, AR: 1, HK: 1 })
redRoute.addNode("AP", { AH: 1, AO: 1 })
redRoute.addNode("AQ", { AR: 1, AS: 1, HL: 1 })
...
redRoute.addNode("HK", { AG: 1, HL: 1, AN: 1, AO: 1 })
redRoute.addNode("HL", { HK: 1, AN: 1, AQ: 1 })
